...
HW_SRCS = ${HW_SRCDIR}/hw.c \
	...
	${HW_SRCDIR}/gen/dram/dram.c \
	${HW_SRCDIR}/gen/motherboard/motherboard.c \
	${HW_SRCDIR}/gen/storage/storage.c \
	${HW_SRCDIR}/gen/nic/nic.c \
	${HW_SRCDIR}/gen/fan/fan.c \
	${HW_SRCDIR}/mpn/dell/0H74DC/0H74DC.c \
	${HW_SRCDIR}/mpn/dell/0N0992/0N0992.c \
	${HW_SRCDIR}/mpn/intel/BX8071512700/BX8071512700.c \
	${HW_SRCDIR}/mpn/intel/WGI219LM/WGI219LM.c \
...
HW_OBJS = ${HW_OBJDIR}/hw.o \
	...
	${HW_OBJDIR}/gen/dram/dram.o \
	${HW_OBJDIR}/gen/motherboard/motherboard.o \
	${HW_OBJDIR}/gen/storage/storage.o \
	${HW_OBJDIR}/gen/nic/nic.o \
	${HW_OBJDIR}/gen/fan/fan.o \
	${HW_OBJDIR}/mpn/dell/0H74DC/0H74DC.o \
	${HW_OBJDIR}/mpn/dell/0N0992/0N0992.o \
	${HW_OBJDIR}/mpn/intel/BX8071512700/BX8071512700.o \
	${HW_OBJDIR}/mpn/intel/WGI219LM/WGI219LM.o \
	${HW_SRCDIR}/mpn/micron/MTC4C10163S1UC48BA1/MTC4C10163S1UC48BA1.c \
...
${HW_OBJDIR}/gen/motherboard/motherboard.o: \
	${HW_SRCDIR}/gen/motherboard/motherboard.c \
	${HW_SRCDIR}/gen/motherboard/motherboard.h \
	${SRCDIR}/spdx/GPL-2.0-or-later.h \
	${HW_SRCDIR}/hw.mk
		@DIR=$@ && DIR=$${DIR%/*} && mkdir -p $${DIR}
		@${CC} -o $@ -c $< ${CFLAGS} ${INCLUDES}
...
${HW_OBJDIR}/gen/storage/storage.o: \
	${HW_SRCDIR}/gen/storage/storage.c \
	${HW_SRCDIR}/gen/storage/storage.h \
	${SRCDIR}/spdx/GPL-2.0-or-later.h \
	${HW_SRCDIR}/hw.mk
		@DIR=$@ && DIR=$${DIR%/*} && mkdir -p $${DIR}
		@${CC} -o $@ -c $< ${CFLAGS} ${INCLUDES}
...
${HW_OBJDIR}/mpn/dell/0N0992/0N0992.o: \
	${HW_SRCDIR}/mpn/dell/0N0992/0N0992.c \
	${HW_SRCDIR}/mpn/dell/0N0992/0N0992.h \
	${SRCDIR}/spdx/GPL-2.0-or-later.h \
	${HW_SRCDIR}/hw.mk
		@DIR=$@ && DIR=$${DIR%/*} && mkdir -p $${DIR}
		@${CC} -o $@ -c $< ${CFLAGS} ${INCLUDES}
...
${HW_OBJDIR}/mpn/intel/WGI219LM/WGI219LM.o: \
	${HW_SRCDIR}/mpn/intel/WGI219LM/WGI219LM.c \
	${HW_SRCDIR}/mpn/intel/WGI219LM/WGI219LM.h \
	${SRCDIR}/spdx/GPL-2.0-or-later.h \
	${HW_SRCDIR}/hw.mk
		@DIR=$@ && DIR=$${DIR%/*} && mkdir -p $${DIR}
		@${CC} -o $@ -c $< ${CFLAGS} ${INCLUDES}
